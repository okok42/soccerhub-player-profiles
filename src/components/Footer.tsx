    ...
    <footer className="bg-gray-800 text-gray-300 py-10">
      <div className="container mx-auto px-4 md:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="font-bold text-white text-lg mb-4">SoccerHub</h3>
            <p className="text-sm">
              Your ultimate destination for information about the world's greatest football players.
              Stay updated with accurate stats, profiles, and the latest news.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><a href="#" className="hover:text-white transition-colors">Top Players</a></li>
